...
hitable *cornell_smoke() {
  ...
  list[i++] = new constant_medium(new translate(new rotate_y(new box(vec3(0, 0, 0), vec3(165, 165, 165), white), -18), vec3(130, 0, 65)), 0.01, new constant_texture(vec3(1.0, 1.0, 1.0)));
  list[i++] = new constant_medium(new translate(new rotate_y(new box(vec3(0, 0, 0), vec3(165, 330, 165), white), 15), vec3(265, 0, 295)), 0.01, new constant_texture(vec3(0.0, 0.0, 0.0)));
